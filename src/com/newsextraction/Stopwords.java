...
public class Stopwords {
	...
	//Global variables to store list of stop words
	...
	//Function to check if a given word is a stemmed stop word
	...
	//Function to remove stemmed stop words from a String
